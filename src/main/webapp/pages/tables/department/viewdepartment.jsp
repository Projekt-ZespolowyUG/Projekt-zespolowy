...
<head lang="pl">
  ...
  <script src="${pageContext.request.contextPath}/js/tables/department/viewdepartment.js" type="text/javascript"></script>
</head>
<body>
  ...
  <div class="showSingle">
    <div class="large-4 medium-6 showSingleImage columns">
      <img src="${pageContext.request.contextPath}/img/firma.jpg" alt="firma">
    </div>
